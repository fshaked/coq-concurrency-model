...
Proof.
  ...
  destruct xs.
  - left. reflexivity.
  - right. intros F. discriminate.
Qed.

Instance list_decide_neq_nil {A} : forall (xs : list A), Decision (xs <> nil).
Proof.
  intros. unfold Decision.
  destruct xs.
  - right. intros F. apply F. reflexivity.
  - left. intros F. discriminate.
Qed.
